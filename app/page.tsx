...
export default function Home() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const queryParams = new URLSearchParams({
        t: Date.now().toString(),
        message: message,
        ...(currentChatSession?.id ? { chatSessionId: currentChatSession.id } : {})
      });

      console.log('Creating EventSource with params:', queryParams.toString());
      const eventSource = new EventSource(`/api/chat/stream?${queryParams.toString()}`);
  ...
  const handleDeleteChat = async (chatSessionId: string) => {
    ...
    try {
      const response = await fetch(`/api/chat/delete?chatSessionId=${chatSessionId}`, {
        method: 'DELETE',
      });
        ...
        <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            {chatSessions.length === 0 ? (
              <div className="p-4 text-gray-500 text-center">No chat sessions yet</div>
            ) : (
              <ul>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {currentChatSession ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-8">
                <h2 className="text-2xl font-bold mb-2">Welcome to Emotional Relief AI</h2>
                <p className="text-gray-600 mb-6">
                  Share your feelings, frustrations, or stressors, and I'll help you process them.
                </p>
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <p className="mb-8 max-w-2xl text-xl text-gray-600">
          Talk to our AI companion about your stress, anger, or frustration. 
          Get emotional relief and continue your day with a clearer mind.
        </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
              Our AI companion is here to listen and help you process your emotions.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-base text-gray-500 text-center">
                Sign up for a free account to get started with our emotional relief AI.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Share Your Feelings</h3>
              <p className="mt-2 text-base text-gray-500 text-center">
                Talk about what's bothering you in a safe, private conversation.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">Feel Better</h3>
              <p className="mt-2 text-base text-gray-500 text-center">
                Experience emotional relief and continue your day with a clearer mind.
              </p>
            </div>
          </div>
        </div>
