          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-7">
                At Emotional Relief AI, we take your privacy seriously. This Privacy Policy explains how we collect, 
                use, disclose, and safeguard your information when you use our service. Please read this policy 
                carefully. By using our service, you consent to the data practices described in this statement.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>
                  ...
                  name (if provided), and authentication information.
                </li>
                <li>
                  <strong>Conversation Data:</strong> We store the content of your conversations with our AI to 
                  provide and improve our service.
                </li>
                <li>
                  <strong>Usage Information:</strong> We collect information about how you interact with our service, 
                  including access times, pages viewed, and the routes by which you access our service.
                </li>
                <li>
                  <strong>Device Information:</strong> We may collect information about the device you use to access 
                  our service, including hardware model, operating system, and browser type.
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-7">
                ...
                comply with our legal obligations, resolve disputes, and enforce our policies. If you wish to 
                request that we delete your data, please contact us at the email address provided below.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>
                  ...
                  service providers, and other third parties who perform services on our behalf.
                </li>
                <li>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>The right to request that we restrict our processing of your personal information</li>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-7">
                ...
                that your child has provided us with personal information, please contact us so that we can take 
                necessary actions.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-7">
                ...
                <span className="text-primary"> privacy@emotionalreliefai.com</span>.
              </p>
            </CardContent>
          </Card>
        </div>
